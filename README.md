...
| [**Intelligent Grimm -- Open-ended Visual Storytelling via Latent Diffusion Models**](https://arxiv.org/abs/2306.00973) | Chang Liu, Haoning Wu, Yujie Zhong, Xiaoyun Zhang, Yanfeng Wang, Weidi Xie |  [Project Page](https://haoningwu3639.github.io/StoryGen_Webpage/) [Code](https://github.com/haoningwu3639/StoryGen) [Dataset](https://huggingface.co/datasets/haoningwu/StorySalon) |   CVPR 2024    |
...
| **Model/Paper** | **Authors/Team** | **Links** | **Venue** |
|--------------------------------|--------------------------------|----------|----------|
| [**ToonComposer: Streamlining Cartoon Production with Generative Post-Keyframing**](https://arxiv.org/abs/2508.10881) | Lingen Li, Guangzhi Wang, Zhaoyang Zhang, Yaowei Li, Xiaoyu Li, Qi Dou, Jinwei Gu, Tianfan Xue, Ying Shan | [Project](https://lg-li.github.io/project/tooncomposer/) | |
